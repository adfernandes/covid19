...
{%- capture country_html -%}[{{ country_text }}](#){:onClick="setPlotSrc('plots/svg/{{ country }}.svg');"}{%- endcapture -%}
{% assign everything = country_html | concat: everything %}
{% endfor %}

{{ everything | array_to_sentence_string | replace: ", ", ",&nbsp;&nbsp;&nbsp; " | replace: " and ", " and&nbsp;&nbsp;&nbsp; " }}

<img id="plot" style="width: 100%; height: auto; border: 1pt solid LightGrey; border-left: 0; border-right: 0;" src="plots/empty.svg">
...
You can reach me at $$\sf\small\text{Andrew Fernandes}\ \email{andrew}{fernandes.org}$$.
